...
<html lang="pl-PL">
	...
	<body class="loggedin">
		...
		<div class="content">
            ...
            <form action="addGroup.php"  enctype="multipart/form-data" method="post" style="display:inline-block; background-color:white;width:100%;padding:20px;" accept-charset="ISO-8859-2">
            ...
            <form action="editGroup.php"  enctype="multipart/form-data" method="post" style="display:inline-block; background-color:white;width:100%;padding:20px;" accept-charset="ISO-8859-2">
            ...
            <form action="addNews.php"  enctype="multipart/form-data" method="post" style="display:inline-block; background-color:white;width:100%;padding:20px;" accept-charset="ISO-8859-2" >
                <b>1.Stwórz nowy wpis</b><br><br>
                <label for="nName">Tytuł</label> <input type="text" name="nName" id="nName" required><br>
                <br>
                <label for="nCont">Treść</label> <textarea id="nCont" name="nCont" placeholder="(tu wpisz treść)" style="height:15vh;width:100%; white-space: pre-wrap;" required></textarea> <br>
            ...
            <form action="editNews.php"  enctype="multipart/form-data" method="post" style="display:inline-block; background-color:white;width:100%;padding:20px;" accept-charset="ISO-8859-2">
                ...
                <select name="newsS" id="newsSelector" onchange="showNEditing()">
                    ...
                    while($group = mysqli_fetch_array($GROUPS)){
                        echo" <option value=".$group['Id_Akt'].">".$group['TytulAkt']."</option>";
                    }
                    ?>
                </select><br>
                ...
                <div class='neditor' id='TrescAkt' style="display:none">
                    ...
                    while( $cont=mysqli_fetch_array($CONTENTS)){
                        echo "<div class='ncontent' id='ncontent".$cont['Id_Akt']."' style='display:none;'>". nl2br($cont['TrescAkt']."</div>";
                    }
                    ?>
                    <br><br>
            ...
            <form action="addAlbum.php"  enctype="multipart/form-data" method="post" style="display:inline-block; background-color:white;width:100%;padding:20px;" accept-charset="ISO-8859-2">
            ...
            <form id="EditingForm" action="editAlbum.php"  enctype="multipart/form-data" method="post" style=" background-color:white;width:100%;padding:20px;" accept-charset="ISO-8859-2">
                ...
                <b>2.Edytuj Album</b><br><br>
                    ...
                    <select name="editS" id="albumEditor" onchange="showEditing()">
                        ...
                        <option value="cCov">Zmień okładkę</option>
                     ...
                     <div class='editingOptions' style='margin-top:3vh;'>
                        ...
                        <div class='editor' id='OpisAlb' style="display:none">
                         ...
                         <div class='editor' id='cCov' style="display:none">
                            <label for="cCov">Wybierz nową okładkę</label> <input type="file" name="cCov" id="cCov">
                        </div>
